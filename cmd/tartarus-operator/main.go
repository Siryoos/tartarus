...
func main() {
	...
	flag.StringVar(&olympusAddr, "olympus-addr", "http://localhost:8080", "Address of the Olympus API")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "tartarus-operator.tartarus.io",
	})
	if err != nil {
	...
	if err = (&controllers.SandboxJobReconciler{
		Client:      mgr.GetClient(),
		Scheme:      mgr.GetScheme(),
		OlympusAddr: olympusAddr,
		HTTPClient:  &http.Client{},
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SandboxJob")
		os.Exit(1)
	}

	if err = (&controllers.SandboxTemplateReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
